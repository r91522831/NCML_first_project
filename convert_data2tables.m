function [trials, load_table, target_table, tp_table] = convert_data2tables(data)
% convert_data2tables
...
for i = 1:length(data.c3d)
    ...
    % KinARM data
    tmp_KinTable = [ data.c3d(i).Right_HandX, data.c3d(i).Right_HandY,...
    ...
    tmp_KinTable.Properties.VariableNames = { 'X', 'Y', 'L1Ang', 'L2Ang', ...
                                        'L1Vel', 'L2Vel', 'L1Acc', 'L2Acc',...
                                        'M1TorCMD', 'M2TorCMD' };
